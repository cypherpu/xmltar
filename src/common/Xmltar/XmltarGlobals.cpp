 ...
 *
 * The files generated by each command-line glob will be generated in order.
 *
 * If --listed-incremental is chosen, then the incremental file will be
 * scanned for each file to be included.
